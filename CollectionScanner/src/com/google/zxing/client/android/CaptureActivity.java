...
import com.airAd.collectionscanner.util.LogUtil;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
        ...
        if (points != null && points.length > 0) {
            ...
            if (points.length == 2) {
                ...
                drawLine(canvas, paint, points[0], points[1]);
                    ...
                    && (rawResult.getBarcodeFormat().equals(BarcodeFormat.UPC_A) || rawResult.getBarcodeFormat().equals(
    ...
    private void initCamera(SurfaceHolder surfaceHolder) {
        try {
            ...
            LogUtil.w(CaptureActivity.class, "Unexpected error initializating camera");
            displayFrameworkBugMessageAndExit();
        }
    }
